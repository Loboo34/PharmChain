    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-secondary/5 flex items-center justify-center p-6">
        <motion.div
          ...
          className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-border p-10 text-center"
        >
          <CheckCircle className="size-16 text-verified-green mx-auto mb-6" />
